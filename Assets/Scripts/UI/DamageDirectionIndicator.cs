...
public class DamageDirectionIndicator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            DamageDirectionIndicatorManager.Instance.StopTrackingTransform(trackingTransform);
    ...
    {
        var camForward = CinemachineCameraManager.Instance.brain.OutputCamera.transform.forward;
        camForward.y = 0;

        var playerToTarget = trackingTransform.position - GameManager.Instance.playerModel.transform.position;
        playerToTarget.y = 0;
