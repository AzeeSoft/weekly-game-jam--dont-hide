...
//        Gizmos.DrawWireSphere(transform.position, 10f);
    ...
    private void Move(float speed)
    {
        ...
        // Move Animation
        Vector3 animVector = playerModel.playerInputController.playerInput.Move;
    ...
    {
        playerModel.animator.SetFloat("Forward", forward);

        playerModel.animator.SetBool("IsGrounded", isGrounded);
        playerModel.animator.SetBool("IsSprinting", isSprinting);
    }
...
//            transform.forward = Vector3.Lerp(transform.forward, targetForward, turnSpeed * Time.fixedDeltaTime);
    ...
    {
        PlayerInputController.PlayerInput playerInput = playerModel.playerInputController.playerInput;

        /*if (playerModel.isMeleeAttacking)
        {
